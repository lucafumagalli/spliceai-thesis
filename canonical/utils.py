...
def print_topl_statistics(y_true, y_pred):
    ...
    print('Top-k accuracy k=0.5: ' + str(topkl_accuracy[0]))
    print('Top-k accuracy k=1: ' + str(topkl_accuracy[1]))
    print('Top-k accuracy k=2: ' + str(topkl_accuracy[2]))
    print('Top-k accuracy k=4: ' + str(topkl_accuracy[3]))
    print('auprc: ' + str(auprc))
    print('Threshold for k=0.5: ' + str(threshold[0]))
    print('Threshold for k=1: ' + str (threshold[1]))
    print('Threshold for k=2: ' + str(threshold[2]))
    print('Threshold for k=0.5: ' + str(threshold[3]))
    print('Number of true splice sites: ' + str(len(idx_true)))
